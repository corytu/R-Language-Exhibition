...
* <a href="https://cran.r-project.org/web/packages/magrittr/vignettes/magrittr.html">magrittr</a>: The most critical function is the "pipe-like" operator `%>%`, which allows people transmit a value or object to an expression or function call.
